...
const FormBuilder: React.FC = () => {
  ...
  const handleCreateForm = (contentTypeId?: string) => {
    if (contentTypeId) {
      navigate(`/form-builder/${contentTypeId}`);
    } else {
      navigate('/content-types');
      toast.info('Please select or create a content type first');
    }
  };
              ...
              <Card key={contentType.id} className="hover:shadow-md transition-shadow">
                ...
                <CardContent>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      size="sm"
                      onClick={() => handleCreateForm(contentType.id)}
                    >
